...
function parseNaturalDue(s) {
  ...
  m = s.match(/^(วันนี้|พรุ่งนี้|พรุ้งนี้|พรุงนี้)(?:\s+(เที่ยง\s*ครึ่ง|เที่ยงครึ่ง|เที่ยง(?:\s*ตรง)?|(\d{1,2})(?:[:.](\d{2}))?))?$/i);
  if (m) {
  ...
  m = s.match(/^(?:วัน)?([ก-๙]+)(นี้|หน้า)(?:\s+(เที่ยง\s*ครึ่ง|เที่ยงครึ่ง|เที่ยง(?:\s*ตรง)?|(\d{1,2})(?:[:.](\d{2}))?))?$/);
...
function parseAssignLoose(text) {
  ...
  if (!deadline) {
    const m = body.match(/(วันนี้|พรุ่งนี้|พรุ้งนี้|พรุงนี้)\s*(เที่ยง\s*ครึ่ง|เที่ยงครึ่ง|เที่ยง(?:\s*ตรง)?|(\d{1,2})(?:[:.](\d{2}))?)/i);
    if (m) {
      if (m[3]) {
  ...
  if (!timeStr) {
    const m = body.match(/เที่ยง\s*ครึ่ง|เที่ยงครึ่ง|เที่ยง(?:\s*ตรง)?/i);
    if (m) {
